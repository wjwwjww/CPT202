...
import com.group37.project_b.repository.userRepo;
...
public class AppointmentAdminController {
    ...
    public String postAppointmentsManagementCreatePage(
        ...
        BindingResult result){
            ...
            newAppointment.setTrainer(trainerrepo.findByTrainerId(AM_DTO.getTrainerID()));
    ...
    public String postAppointmentsManagementUpdatePage(
        ...
        BindingResult result){
            ...
            try{
                ...
                appointment.setTrainer(trainerrepo.findByTrainerId(AM_DTO.getTrainerID()));
