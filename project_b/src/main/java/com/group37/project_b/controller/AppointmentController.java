...
import com.group37.project_b.model.AppointmentManagementDTO;
...
public class AppointmentController {
    ...
    public String getAppointmentsManagementPage(Model m) {
        ...
        for(Appointment a: Appointments){
            if(a.getAppointmentTime().getYear() == LocalDateTime.now().getYear()){
                ...
                if(!trainerYear.containsKey(a.getTrainerID())){
                    trainerYear.put(a.getTrainerID(), Arrays.asList(0,0));
                }
                trainerYear.get(a.getTrainerID()).set(0, trainerYear.get(a.getTrainerID()).get(0)+1);
                trainerYear.get(a.getTrainerID()).set(1, trainerYear.get(a.getTrainerID()).get(0)+a.getRating());

                if(a.getAppointmentTime().until(LocalDateTime.now(), ChronoUnit.DAYS) <= 31){
                    counterThirty++;
                    totalRatingThirty += a.getRating();
                    if(!trainerThirty.containsKey(a.getTrainerID())){
                        trainerThirty.put(a.getTrainerID(), Arrays.asList(0,0));
                    }
                    trainerThirty.get(a.getTrainerID()).set(0, trainerThirty.get(a.getTrainerID()).get(0)+1);
                    trainerThirty.get(a.getTrainerID()).set(1, trainerThirty.get(a.getTrainerID()).get(0)+a.getRating());
                }
            }
        }
        ...
        return "/AppointmentsManagement/AppointmentsManagement";
    }

    @GetMapping("/Appointments_Management/create")
    public String getAppointmentsManagementCreatePage(Model m) {
        ...
        return "/AppointmentsManagement/AppointmentsManagementCreate";
    }

    @PostMapping("/Appointments_Management/create")
    public String postAppointmentsManagementCreatePage(
        ...
        BindingResult result){
            ...
            newAppointment.setCustomerID(AM_DTO.getCustomerID());
            newAppointment.setTrainerID(AM_DTO.getTrainerID());
            ...
            return "redirect:/Appointments_Management";
    }


    @GetMapping("/Appointments_Management/update")
    public String getAppointmentsManagementUpdatePage(
        ...
        try{
            ...
            AppointmentManagementDTO AM_DTO = new AppointmentManagementDTO();
            AM_DTO.setCustomerID(appointment.getCustomerID());
            AM_DTO.setTrainerID(appointment.getTrainerID());
        ...
        return "/AppointmentsManagement/AppointmentsManagementUpdate";
    }


    @PostMapping("/Appointments_Management/update")
    public String postAppointmentsManagementUpdatePage(
        ...
        BindingResult result){
            ...
            try{
                ...
                appointment.setCustomerID(AM_DTO.getCustomerID());
                appointment.setTrainerID(AM_DTO.getTrainerID());
    ...
    @GetMapping("/Appointments_Management/delete")
